...
class Version < ApplicationRecord
  ...
  def self.prepare(ft_id, current_user, model, new_attrs)
    ...
    new(family_tree_id: ft_id, user_id: current_user.id, model: model.class.name, model_id: model.id, model_changes: result)
  end
